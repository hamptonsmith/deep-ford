...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.ec7b142fa8d13d8cbdd5371c55cf4680dfd799a9514ae9773cb43ee84d31d0b9.js',function(){input.required=false;search();});}
