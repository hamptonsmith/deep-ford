...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.ff7797fbdd70da835cdbd6459653aab7b4d850b7ba00879f25d4ceec0863afc4.js',function(){input.required=false;search();});}
