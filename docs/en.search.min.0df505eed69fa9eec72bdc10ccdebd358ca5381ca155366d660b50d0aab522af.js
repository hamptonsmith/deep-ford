...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.3427ef30951f97bcadf9ecb3e3be787cb97412a63d550998d440ac3e1027c1e7.js',function(){input.required=false;search();});}
