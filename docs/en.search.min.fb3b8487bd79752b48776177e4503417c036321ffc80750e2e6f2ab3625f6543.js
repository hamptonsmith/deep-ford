...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.1e5eb8bff1475b996bceaa03aa41fd9949fed217da756c51f44c05bc662d1d33.js',function(){input.required=false;search();});}
