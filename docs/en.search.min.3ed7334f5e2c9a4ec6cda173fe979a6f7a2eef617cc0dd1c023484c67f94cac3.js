...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.56932fa7cbcb23b9517734651ac7cb086387db2e965ecfb6921f7d95a454d80b.js',function(){input.required=false;search();});}
