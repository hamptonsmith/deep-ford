...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.17d816fd4b317865bbdb28982cbaff195bf7e0507c44440a231e12c983206aa6.js',function(){input.required=false;search();});}
