...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/deep-ford/flexsearch.min.js');loadScript('/deep-ford/en.search-data.min.3baec32acb2b09f231ad36adc47793654222876d3ef10f4225be3dadb259fe7b.js',function(){input.required=false;search();});}
